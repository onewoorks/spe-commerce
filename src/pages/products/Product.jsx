...
const ProductProduct = (props) => {
    ...
    let mobileView = (window.innerWidth > 576) ? false : true
    ...
    return (
        <div className="container">
            <div className="card mb-3">
                ...
                <div className={(mobileView) ? '' : "row no-gutter"} >
                    <div className={ (mobileView) ? '' : "col-5"} >
                        <img
